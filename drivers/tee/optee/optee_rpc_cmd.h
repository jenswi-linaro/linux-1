...
/*
 * No RPC command, used to indicate that no RPC command is present if
 * applicable.
 */
#define OPTEE_RPC_CMD_NONE		0xffffffff
...
/*
 * Deliver an interrupt in normal world, normal world just returns
 * immediately.
 */
#define OPTEE_RPC_CMD_INTERRUPT		11
